...
[![Backend](https://img.shields.io/badge/Backend-Spring_Boot-6DB33F?style=for-the-badge&logo=springboot)](https://github.com/Jangjimin9766/Mine_server)
...
### 📌 프로젝트 개요
- **개발 기간**: 2024.09 ~ 현재 (진행 중)
- **개발 규모**: Full-Stack 단독 개발 (Backend + AI Server)
- **프로젝트 설명**: 사용자가 원하는 모든 주제를 Vogue, GQ 스타일의 프리미엄 매거진으로 자동 생성하는 AI 서비스
...
```
✓ FastAPI                 ✓ OpenAI GPT-3.5-turbo
✓ Stable Diffusion XL     ✓ Tavily Search API
✓ Jina AI Reader          ✓ PyTorch (MPS)
...
└─┬────────┬─────────┬─────────────────┘
  ...
  ▼        ▼         ▼
┌────────┐┌───────┐┌──────────┐
│ OpenAI ││Tavily ││Stable    │
│  GPT   ││Search ││Diffusion │
└────────┘└───────┘└──────────┘
```
